...
<main>
    <div class="uk-container gak-container">
        ...
        <h2 class="uk-margin-bottom gak-header gak-margin-top-80">Wynajem pomieszczenia</h2>
                            ...
                            $counter = 0; ?>
                                ...
                                <ol class="js-filter uk-grid-small" uk-grid>
                                    ...
                                    <?php
                                            ...
                                            // Loop through rows.
                                            while( have_rows('wynajem_grupa') ) : the_row();
                                            $counter++;
