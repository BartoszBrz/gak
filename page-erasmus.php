...
<main>
    <div class="uk-container gak-container uk-margin-large-top">
        ...
        <div class="gak-section-header">
            ...
            <h2 class="gak-header">Projekt Erasmus+</h2>
        ...
        <div class="uk-margin-large-bottom uk-margin-large-top" uk-grid>
            ...
            <div class="gak-width-100">
                ...
                if( have_rows('erasmus_grupa') ):
                    $counter = 0;
                    // Loop through rows.
                    while( have_rows('erasmus_grupa') ) : the_row(); ?>
                    ...
                    <?php
                        ...
                        $sub_value5 = get_sub_field('erasmus_galeria');
                    ?>
                            ...
                            <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical uk-padding-remove gak-light-blue">
                                ...
                                <div class="uk-grid-collapse" uk-grid>
                                    ...
                                    <div class="uk-width-1-1 gak-light-blue gak-modal-padding-big gak-modal-logo">
                                        ...
                                        <?php $galeria_images = get_sub_field( 'erasmus_galeria' ); ?>

                                            <?php if ( $galeria_images ) : ?>
                                                <?php foreach ( $galeria_images as $galeria_image ): ?>                                              
                                             
                                                    <a class="uk-inline" href="<?php echo $galeria_image ?>" >
                                                        <img src="<?php echo $galeria_image ?>" alt="">
                                                    </a>  
