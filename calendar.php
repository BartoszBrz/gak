            ...
            <div uk-grid>
                ...
                <div class="gak-form-100">
                    ...
                    <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid">
                        ...
                        <a class="gak-reset-fields <?php echo (empty($_SERVER['QUERY_STRING']) ? 'gak-disabled-reset' : ''); ?>" href="<?php echo $base_url; ?>">
                            wyczyść filtry
                        </a>
                    </div>
                </div>
                ...
                <div class="gak-filter-btn-box">
                    ...
                    <button class="gak-small-calendar-box__link gak-arrow-link gak-btn-filter-events" aria-label="Wyszukaj wydarzenie"><span aria-hidden="true">___</span>wyszukaj wydarzenie</button>
