...
<main>
    <div class="uk-container gak-container">
        ...
        <h2 class="gak-header gak-availability-header">Dla mediów</h2>
                                    ...
                                    <?php
                                        ...
                                        <a class="gak-card-link" href="<?php echo $file['url']; ?>" title="Otwiera nowe okno">
                                            ...
                                            <div class="gak-rent-box gak-rent-box-noimg">
                                                ...
                                                <span class="gak-rent-link gak-arrow-link-white gak-download"><span aria-hidden="true">___</span>czytaj więcej</span>
